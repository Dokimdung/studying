...
function BodyLeftCalendar1() {
    const router = useRouter()
    return (
        <div className="bg-white  w-[30%]">
            <div onClick={() => router.push('/calendar')} className="bg-[#49BBBD] border-none w-[10%] ml-5 ">
                <IconButton>
            ...
            <div className="m-5">
                ...
                <div className="flex justify-around bg-[#49BBBD] rounded-xl m-2   ">
...
export default BodyLeftCalendar1;